!(function() {
	...
	var TreeComp = React.createClass({
		...
		render: function() {
			...
			return (
				<div className="row">
					<div className="col-md-3 well"><TUI.Tree {...treeOptions} /></div>
					<div className="col-md-8 col-md-offset-1 well">当前选中：{this.state.value}</div>
				</div>
			);
		}
	});

	ReactDOM.render(<TreeComp />, document.getElementById('treeDOM'));
