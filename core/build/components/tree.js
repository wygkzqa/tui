(function () {
	var TreeComp = React.createClass({
		...
		changeCheckbox: function (e) {
			...
			checkedVals = this.state.checkedVals, childCheckedStatus = this.state.childCheckedStatus, index = '';
			...
			return React.createElement(
				...
				this.state.trees.map((function (parent, key) {
					...
					if (this.props.checkbox == true) {
						parentCheckboxDOM = React.createElement('input', { type: 'checkbox', defaultValue: parent[this.props.checkboxValueField], onChange: this.changeCheckbox, 'data-parent': 'true', style: { 'marginRight': '3' } });
					}
