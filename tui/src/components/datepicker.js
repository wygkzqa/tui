				...
				<div className={'panel panel-default ' + this.state.className}>
					<div className="panel-body">
						<div className="tui-datepicker-head">
							<a onClick={this.prevMonth} href="javascript:;" className="pull-left" style={{'padding': '8', 'margin': '8px 0', 'lineHeight': '0'}}><i className="fa fa-arrow-left"></i></a>
							<a href="javascript:;" style={{'padding': '8px 50px'}}>{this.state.month + '月'}&nbsp;{this.state.year}</a>
							<a onClick={this.nextMonth} href="javascript:;" className="pull-right" style={{'padding': '8', 'margin': '8px 0', 'lineHeight': '0'}}><i className="fa fa-arrow-right"></i></a>
						</div>
						<table>
							<thead>
								<tr>
							...
							<tbody>
								{
									this.state.daysObj.map(function(d, key) {
										...
										for (var i = 0; i < daysArr.length; i++) {
											daysDOM.push(<td key={i} data-day={daysArr[i]} onClick={this.setDate}><a data-day={daysArr[i]} href="javascript:;">{daysArr[i]}</a></td>);
										}
